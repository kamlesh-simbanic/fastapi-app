...
from .. import schemas, database, controllers, utils
from .auth import get_current_user

router = APIRouter(
    prefix="/fee-structure",
    tags=["Fee Structure"]
)
...
def create_fee_structure(
    ...
    return controllers.fee_structure.create_fee_structure(db, fee_schema, current_user.id)
...
def update_fee_structure(
    ...
    return controllers.fee_structure.update_fee_structure(db, fee_id, fee_schema, current_user.id)
