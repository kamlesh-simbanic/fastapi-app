...
def list_classes(
    ...
    return controllers.school_class.list_classes(db, skip, limit, sort_by, order, search)
...
def update_class(
    ...
    return controllers.school_class.update_class(db, class_id, class_schema, current_user.id)
