...
router = APIRouter(
    ...
    dependencies=[
        Depends(
            check_access(
                [
                    models.Department.ADMIN,
                    models.Department.TEACHING,
                    models.Department.MANAGEMENT,
                ]
            )
        )
    ],
...
def get_students(
    ...
    return controllers.students.get_students(
        db, skip, limit, sort_by, order, search, student_ids
    )
