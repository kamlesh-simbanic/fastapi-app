...
@router.post("/", response_model=schemas.HolidayOut, status_code=status.HTTP_201_CREATED)
def create_holiday(
...
def update_holiday(
    ...
    return controllers.holiday.update_holiday(db, holiday_id, holiday_update, current_user.id)
